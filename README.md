phpMyAdmin 5.x command-line interface
=================================
...
* [phpMyAdmin](http://www.phpmyadmin.net/) 5.x
...
``` sh
git clone git://github.com/barkanyidominik/phpmyadmin-cli-5.git
cd phpmyadmin-cli-5
...
``` sh
pip install git+http://github.com/barkanyidominik/phpmyadmin-cli-5
```
...
Compatibility
-------------
While phpmyadmin-cli should work with phpMyAdmin 5.x, it has only been 
tested with on 5.2.1.
